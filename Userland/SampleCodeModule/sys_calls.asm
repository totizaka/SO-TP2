...
GLOBAL syscall_my_mem_state
GLOBAL syscall_my_free_mem_state
GLOBAL syscall_my_create_pipe
...
syscall_my_mem_state:
    mov rax, 0x21
    int 80h
    ret

syscall_my_free_mem_state:
    mov rax, 0x22
    int 80h
    ret
...
syscall_my_get_available_pipe_id:
    mov rax, 0x29
    int 80h
    ret
